...
void OS::___init_method_bindings() {
	...
	___mb.mb_get_current_tablet_driver = godot::api->godot_method_bind_get_method("_OS", "get_current_tablet_driver");
	...
	___mb.mb_get_native_handle = godot::api->godot_method_bind_get_method("_OS", "get_native_handle");
	...
	___mb.mb_get_screen_max_scale = godot::api->godot_method_bind_get_method("_OS", "get_screen_max_scale");
	...
	___mb.mb_get_screen_scale = godot::api->godot_method_bind_get_method("_OS", "get_screen_scale");
	...
	___mb.mb_get_tablet_driver_count = godot::api->godot_method_bind_get_method("_OS", "get_tablet_driver_count");
	___mb.mb_get_tablet_driver_name = godot::api->godot_method_bind_get_method("_OS", "get_tablet_driver_name");
	___mb.mb_get_thread_caller_id = godot::api->godot_method_bind_get_method("_OS", "get_thread_caller_id");
	...
	___mb.mb_keyboard_get_current_layout = godot::api->godot_method_bind_get_method("_OS", "keyboard_get_current_layout");
	___mb.mb_keyboard_get_layout_count = godot::api->godot_method_bind_get_method("_OS", "keyboard_get_layout_count");
	___mb.mb_keyboard_get_layout_language = godot::api->godot_method_bind_get_method("_OS", "keyboard_get_layout_language");
	___mb.mb_keyboard_get_layout_name = godot::api->godot_method_bind_get_method("_OS", "keyboard_get_layout_name");
	___mb.mb_keyboard_set_current_layout = godot::api->godot_method_bind_get_method("_OS", "keyboard_set_current_layout");
	...
	___mb.mb_set_current_tablet_driver = godot::api->godot_method_bind_get_method("_OS", "set_current_tablet_driver");
	___mb.mb_set_environment = godot::api->godot_method_bind_get_method("_OS", "set_environment");
	...
	___mb.mb_set_window_mouse_passthrough = godot::api->godot_method_bind_get_method("_OS", "set_window_mouse_passthrough");
	...
	godot::api->godot_string_name_new_data(&class_name, "_OS");
